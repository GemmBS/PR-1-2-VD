---
title: "From silence to saturation: Two centuries of Irish Biodiversity (1837-2024)"
...
```{r}
knitr::include_graphics("Images/Captura.345PNG.PNG")
```
...
```{r}
knitr::include_graphics("Images/Captura3.PNG")
```
...
```{r}
knitr::include_graphics("Images/Captura4.PNG")
```
...
```{r}
knitr::include_graphics("Images/Captura5.PNG")
```
...
```{r}
knitr::include_graphics("Images/Captura6.PNG")
```
...
```{r}
knitr::include_graphics("Images/Captura7.PNG")
```
...
```{r}
knitr::include_graphics("Images/Captura8.PNG")
```
